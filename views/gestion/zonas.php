<div class="row pt-4">
    <div class="col-lg-12">
        <div class="card shadow-2xl">
            <img class="card-img-top" src="<?php echo IMG_PATH; ?>card-img/zonas_head.png" alt="Zonas" style="filter: blur(8px);   -webkit-filter: blur(8px); height: 250px; object-fit: cover;">
            <div class="card-body">
                <div class="row text-center m-t-0 p-l-10 p-r-10 mb-4">
                    <div class="col-12 m-t-20">
                        <h3 class="m-b-0 font-normal zonas-count"></h3>
                        <h6 class="font-bold m-b-10">Zonas Agregadas</h6>
                    </div>
                </div>
                <h4 class="card-title text-center">Gestión de Zonas</h4>
                <p class="card-text text-center">Gestiona los Zonas agregadas o agrega nuevas zonas para su uso práctico.</p>
                <div class="row">
                    <div class="col-lg-9">
                    ...
                    <div class="col-sm-12 col-lg-3 mb-4 text-center">
                        <button type="button" onclick="crud_zona()" class="btn btn-outline-info btn-rounded col-auto mr-4" data-mdb-ripple-color="dark" title="Agrega Nuevo Distrito"><i class="mdi mdi-plus"></i></button>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content animated bounceInRight">
                    <div class="modal-header">
                        <h4 class="modal-title lead zone_title_modal"></h4>
                        ...
                        <div class="row floating-labels m-t-40">
                            ...
                            <div class="col-lg-12 pb-2">
                                <div class="form-group">
                                    <label for="zone_name">Nombre</label>
                                    <input type="text" id="zone_name" class="form-control" placeholder="Nombre de la Zona" aria-describedby="help_name">
                                </div>
                            </div>
                            <div class="col-lg-12 pb-2">
                            ...
                            <div class="col-lg-12 pb-2">
                                <label for="zone">Estado</label>
                                <select aria-describedby="help_state" id="zone_state" class="form-control selectpicker border" data-live-search="true">
                                    <option value="">Selecciona una opción</option>
