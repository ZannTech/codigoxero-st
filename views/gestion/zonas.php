            ...
            <div class="card-body">
                <div class="row text-center m-t-0 p-l-10 p-r-10 mb-4">
                    <div class="col-12 m-t-20">
                        <h3 class="m-b-0 font-normal zonas-count" style="font-size: 30px;"></h3>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-3 mb-4 text-center">
                        <button type="button" onclick="crud_zona()" class="btn btn-info btn-rounded col-auto mr-4" data-mdb-ripple-color="dark" title="Agrega Nuevo Distrito"><i class="mdi mdi-plus"></i></button>
